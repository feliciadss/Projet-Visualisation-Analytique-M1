        ...
        html.Div(
            ...
            children=[
                ...
                html.Div(
                    ...
                    children=[dcc.Graph(id="sankey-graph", style={"height": "375px"})],
                ),
                dcc.Store(
                    id="selected-genres-collab",
                    data={genre: genre == "electronic" for genre in genres},
                ),
            ],
        ),
        # Collaboration table for top 10 collaborations
        html.Div(
            id="collaboration-table-container",
...
@callback(Output("sankey-graph", "figure"), Input("selected-genres-collab", "data"))
...
def update_collaboration_table(click_data):
    ...
    data_manager = DataManager()
    top_collabs_df = data_manager.get_top_collabs_between_genres(
        source_genre, target_genre
    )

    top_collabs_df = top_collabs_df.rename(
        columns={
    ...
    columns = [
        ...
        for col in top_collabs_df.columns
    ]
